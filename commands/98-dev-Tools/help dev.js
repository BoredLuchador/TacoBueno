	...
	run: async (client, message) => {
		...
		const devembed = new Discord.MessageEmbed()
			...
			.addFields(
				...
				{ name: 'Random things you should\'ve learned lmao', value: '[Folder stuff](https://estk.aenhancers.com/3%20-%20File%20System%20Access/using-file-and-folder-objects.html), [Mozilla docs](https://developer.mozilla.org/en-US/docs/Web/JavaScript)' },
